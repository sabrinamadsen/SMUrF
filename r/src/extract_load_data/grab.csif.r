...
grab.csif <- function(csif.path, timestr, sif.temp, TA.path, TA.varname, 
    ...
    if ((search.timestr-yr*1000)<90 | (search.timestr-yr*1000)>340){
      csif.file <- "C:/Users/kitty/Documents/Research/SIF/SMUrF/data/TROPOSIF/winter_sif.nc"
